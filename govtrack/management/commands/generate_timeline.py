...
#        parser.add_argument('country_code', nargs='+', type=str)
    ...
    def handle(self, *args, **options):
        self.stdout.write(self.style.SUCCESS('About to generate population count for some country'))
        try:
        ...
        self.stdout.write(self.style.SUCCESS('Generated population count for country "%s"' % country_code))
