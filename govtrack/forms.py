...
class CountryForm(ModelForm):
    ...
    admin_notes = forms.CharField(
        widget=forms.Textarea, label="Admin Notes", required=False
    )
...
class DeclarationForm(ModelForm):
    ...
    description_short = forms.CharField(
        widget=forms.Textarea, label="Summary", required=False
    )
    description_long = forms.CharField(
        widget=forms.Textarea, label="Details", required=False
    )
    admin_notes = forms.CharField(
        widget=forms.Textarea, label="Admin Notes", required=False
    )
...
class BulkAreaForm(Form):
    ...
    link = forms.CharField(
        required=False, label="Add link", validators=[URLValidator()]
    )
    supplements_add = forms.MultipleChoiceField(
        label="Add supplementary parents", required=False
    )
    supplements_rm = forms.MultipleChoiceField(
        label="Remove supplementary parents", required=False
    )
